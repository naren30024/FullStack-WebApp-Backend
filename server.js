...
app.use(bodyParser.json());
  ...
  app.post('/api/users/update', async (req, res) => {
    ...
    try{
        ...
        await pool.query(insertQuery, [regionId, name, age,gender,caste,religion,education,employement,voterId,boothNo,preVotingDate,preVoteTo,membership,affiliation,influenceFactor,fatherName,id]);
